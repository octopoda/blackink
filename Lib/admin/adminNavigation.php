...
/* =======================================
   ...
   ===================================== */
		public function listMainNav() {
			...
			$result_set = $db->queryFill("SELECT admin_id FROM adminNavigation where parent_id = 0");
		...
		public function listTabs($id) {
			...
			$tab_set = $db->queryFill("SELECT admin_id FROM adminNavigation WHERE parent_id = {$id}");
